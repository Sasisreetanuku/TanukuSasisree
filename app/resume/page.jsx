...
const about = {
  title: "About Me",
  description: "I specialize in backend development using java and have solid skills in database management and SQL servers. I am also proficient in various programming languages and technologies.",
  info:[
    {
      fieldName: "Name",
      fieldValue: "Tanuku Sasisree",
    },
    {
      fieldName: "Gender",
      fieldValue: "Female",
    ...
    {
      fieldName: "Phone",
      fieldValue: "(+91) 9390460409",
    },
    {
      fieldName: "Email",
      fieldValue: "sasisreetanuku1234@gmail.com",
    },
    {
...
const education = {
  ...
  items : [
    ...
    {
      institute : "Narayana EM High school, Kadapa",
      degree : "X class",
