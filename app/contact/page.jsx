...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+91) 9390460409",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "sasisreetanuku1234@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "Haripuram colony, 517505, Andhra Pradesh, India",
  },
];
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://sheetdb.io/api/v1/twy20uatlng43", {
        method: "POST",
        headers: {
          ...
          <div className="flex flex-col xl:flex-row gap-[30px]">
            <div className="xl:h-[54%] order-2 xl:order-none w-full xl:w-[50%]">
              <form method="POST" onSubmit={handleSubmit} className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
                ...
                I specialize in backend development using java and have solid skills in database management and SQL servers. I am also proficient in various programming languages and technologies.
                </p>
